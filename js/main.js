...
(function () {
  ...
  // The block between the CMS markers is regenerated by the admin panel —
  // edit it there, or by hand, but keep the markers in place.
  /* CMS:terminal-lines:start */
  var SCRIPT = [
